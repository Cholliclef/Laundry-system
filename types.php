					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								...
								<button class="btn btn-sm btn-default col-sm-3" type="button" onclick="$('#manage-type').get(0).reset()"> Cancel</button>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$cats = $conn->query("SELECT * FROM laundry_type order by id asc");
...
<script>
	...
	$('.delete_cat').click(function(){
		_conf("Are you sure to delete this type?","delete_cat",[$(this).attr('data-id')])
	})
